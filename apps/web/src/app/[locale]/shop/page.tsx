    ...
    <main className="relative isolate min-h-screen overflow-x-clip bg-surface-1 qa-scan">
      ...
      <div className="relative hidden md:flex md:flex-col md:min-h-screen">
        ...
        <div className="relative flex items-end justify-between gap-6 px-10 pt-7">
          <div>
            ...
            <p className="m-0 mt-1 text-[13px] text-fg-3">{t("packs.subtitle")}</p>
          </div>
          <BalanceBadge />
        </div>
        ...
        <div className="relative grid grid-cols-5 gap-2.5 px-10 pb-10 pt-[18px]">
          {BOOST_CARDS.map((c) => (
      ...
      <div className="relative flex min-h-screen flex-col md:hidden">
        ...
        <div className="flex gap-1.5 px-[18px] pt-3.5">
          <div
            className="flex-1 rounded-md border border-violet/40 bg-violet/[0.18] py-2 text-center font-display text-[11px] font-semibold text-white"
          >
            {t("tabs.credits")}
          </div>
          <div
            className="flex-1 rounded-md border border-white/[0.08] bg-white/[0.03] py-2 text-center font-display text-[11px] font-semibold text-fg-3"
          >
            {t("tabs.cards")}
          </div>
        </div>
        ...
        <div className="flex flex-col gap-1.5 px-[18px] pt-1.5 pb-[18px]">
